...
const usage = cmd('h `articleName` `@Mention1` `@Mention2`...') // String showing usage
const examples = [cmd('h cs <@702735514884898867>'), cmd('h dualpc')] // String or Array of examples
